...
class SequenceEncoderDecoder(nn.Module):
    ...
    @classmethod
    def from_pretrained(cls, ckpt_dir: str, ckpt_name: str = 'last.ckpt', device: str = 'cpu') -> 'SequenceEncoderDecoder':
        ...
        state_dict = torch.load(os.path.join(ckpt_dir, 'checkpoints', ckpt_name), map_location=device, weights_only=True)['state_dict']
